...
const styles = {
  wrap: {
    ...
    padding: '12px clamp(10px, 2vw, 18px) 16px',
    flexShrink: 0,
  ...
  chipRm: { background: 'none', border: 'none', color: 'var(--muted)', cursor: 'pointer', fontSize: '0.7rem', padding: '0 2px', flexShrink: 0 },
  uploadingChip: { fontSize: '0.65rem', color: 'var(--muted)', alignSelf: 'center' },
  row: {
    display: 'flex',
    alignItems: 'flex-end',
    gap: 8,
    background: 'var(--surface-glass-68)',
    border: '1px solid var(--border)',
    borderRadius: 16,
    padding: 7,
    boxShadow: 'inset 0 1px 0 var(--surface-glass-72)',
  },
  attachBtn: {
    background: 'linear-gradient(145deg, rgba(var(--accent-rgb), 0.13), rgba(var(--accent2-rgb), 0.14))',
    border: '1px solid var(--border)',
    borderRadius: 12,
    padding: '9px 11px',
    cursor: 'pointer',
  ...
  sendBtn: {
    ...
    flexShrink: 0,
    alignSelf: 'flex-end',
    boxShadow: '0 10px 22px rgba(var(--accent-rgb), 0.25)',
  },
}
